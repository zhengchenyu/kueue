...
type TestJobInformer interface {
	...
	Lister() kueuev1alpha1.TestJobLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KueueV1alpha1().TestJobs(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KueueV1alpha1().TestJobs(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KueueV1alpha1().TestJobs(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KueueV1alpha1().TestJobs(namespace).Watch(ctx, options)
			},
		}, client),
		&apiskueuev1alpha1.TestJob{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *testJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiskueuev1alpha1.TestJob{}, f.defaultInformer)
}

func (f *testJobInformer) Lister() kueuev1alpha1.TestJobLister {
	return kueuev1alpha1.NewTestJobLister(f.Informer().GetIndexer())
}
